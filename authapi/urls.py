...
from account.views import Userregister,UserLoginView,UserprofileView,UserPasswordChangeView
urlpatterns = [
    ...
    path('api/user/change_password',UserPasswordChangeView.as_view())
]
